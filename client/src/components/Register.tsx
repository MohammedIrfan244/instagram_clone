...
function Register() {
  ...
  return (
    ...
    <div className='w-[190px] overflow-hidden mt-5'>
      ...
      {/* <form>
      <input type="text" className='bg-[#121212] text-xs px-2 focus:outline-none border-[1px] border-gray-700 w-full h-9 mt-7' placeholder='Moblie Number or Email'/>
      ...
      <input type="text" className='bg-[#121212] text-xs px-2 focus:outline-none border-[1px] border-gray-700 w-full h-9 mt-2' placeholder='Full Name'/>
      <input type="text" className='bg-[#121212] text-xs px-2 focus:outline-none border-[1px] border-gray-700 w-full h-9 mt-2' placeholder='Username'/>
      ...
      <button className='bg-blue-700 hover:bg-blue-500 mb-10 w-full h-8 mt-4 rounded-lg text-xs font-semibold'>Sign up</button>
      </form> */}
      <Formik
      ...
      >
        {({errors,touched})=>(
          <Form>
            ...
            <p className='text-[11px] text-gray-300 mt-3 text-center'>People who use our service may have uploaded your contact information to Instagram. <span className='text-white hover:cursor-pointer'> Learn More</span></p>
            <p className='text-gray-300 text-[11px] mt-2 text-center'>By signing up, you agree to our <span className='text-white hover:cursor-pointer'> Terms , Privacy Policy and Cookies Policy .</span></p>
            <button type='submit' className='bg-blue-700 hover:bg-blue-500 mb-10 w-full h-8 mt-4 rounded-lg text-xs font-semibold'>Sign up</button>
          </Form>
        )}
      </Formik>
    </div>
