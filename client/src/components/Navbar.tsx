...
></path>
    ...
    <NavLink to={'/message'} className='flex hover:bg-gray-700 rounded-lg text-sm items-center gap-3 py-2 px-1'><RiMessengerLine className='text-2xl' />Message</NavLink>
    <NavLink to={'/notification'} className='flex hover:bg-gray-700 rounded-lg text-sm items-center gap-3 py-2 px-1'><IoMdHeartEmpty className='text-2xl' />Notifications</NavLink>
    <NavLink to={'/post'} className='flex hover:bg-gray-700 rounded-lg text-sm items-center gap-3 py-2 px-1'><AiOutlinePlusSquare  className='text-2xl'/>Create</NavLink>
