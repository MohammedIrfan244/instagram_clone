...
function Login() {
  ...
  return (
    ...
    <div className="bg-black w-[350px] h-[415px] border border-gray-700 flex flex-col items-center px-10 pt-7">
      ...
      <form action="">
      <input type="text" className='bg-[#121212] text-xs px-2 focus:outline-none border-[1px] border-gray-700 w-full h-9 mt-7' placeholder='Username or Email'/>
    ...
    <div className='w-[350px] h-[60px] bg-black border border-gray-700 flex items-center mt-3 justify-center'>
        ...
        <button className='text-xs text-blue-500 font-semibold ms-1' onClick={()=>navigate('/user/register')}>Sign up</button>
    </div>
