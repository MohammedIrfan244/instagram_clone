...
function HomePage(): JSX.Element {
  ...
  return (
    <div className="flex w-full min-h-screen relative">
      ...
      <div className="border-r border-gray-800 w-[250px] bg-black flex flex-col justify-evenly fixed h-full ps-6">
        ...
        <p className='flex items-center gap-3'><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 50 50" style={{ fill: "white" }}>
  <path 
